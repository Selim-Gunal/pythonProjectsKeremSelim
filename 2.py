...
while (x < 4000000 and y < 4000000 and z < 4000000 and u < 4000000):
    z = x + y
    if (z % 2 == 0):
        sum_of_can_devide_two = sum_of_can_devide_two + z
    u = y + z
    if (u % 2 == 0):
        sum_of_can_devide_two = sum_of_can_devide_two + u
    x = z + u
    if (x % 2 == 0):
        sum_of_can_devide_two = sum_of_can_devide_two + x
    y = u + x
    if (y % 2 == 0):
        sum_of_can_devide_two = sum_of_can_devide_two + y

#We've added two because at first we've started with 3 three
print(sum_of_can_devide_two + 2)